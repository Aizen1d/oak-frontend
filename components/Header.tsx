...
const Header = () => {
  ...
  return (
    ...
    {/* Mobile screen: Hamburger opened */}
      <nav className={`fixed top-0 left-0 z-30 bg-HEADER w-full
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="w-1/2 flex justify-end items-end">
            <div 
              ...
              <label className="text-BLACK_LABEL_TEXT text-xl font-bold border border-BLACK_LABEL_TEXT rounded-lg px-3 py-1 hover:cursor-pointer">X</label>
            </div>
          </div>
        </div>
      </nav>
